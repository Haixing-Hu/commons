...
public class IntUtilsTest {
  ...
  private static final int[] AREA = {Integer.MIN_VALUE, Integer.MIN_VALUE/2, -1, 0,
  ...
  public void testToByte_Integer_byte() {
    final byte[] a = {Byte.MIN_VALUE, Byte.MIN_VALUE/2, (byte) -1, (byte) 0, (byte) 1,
                      Byte.MAX_VALUE/2, Byte.MAX_VALUE};
  ...
  public void testToLong_int() {
    for ( int i = 0; i < AREA.length; ++i) {
      assertEquals((long) AREA[i], IntUtils.toLong(AREA[i]));
    }
  }
  ...
  public void testToLong_Integer() {
    ...
    for ( int i = 0; i < AREA.length; ++i) {
      final Integer x = AREA[i];
      assertEquals((long) AREA[i], IntUtils.toLong(x));
    }
  }
  ...
  public void testToLong_Integer_long() {
    ...
    for ( int i = 0; i < AREA.length; ++i) {
      final Integer x = AREA[i];
      for ( int j = 0; j < a.length; ++j) {
        assertEquals((long) AREA[i], IntUtils.toLong(x, a[j]));
      }
    }
  }
  ...
  public void testToFloat_int() {
    for ( int i = 0; i < AREA.length; ++i) {
      assertEquals((float) AREA[i], IntUtils.toFloat(AREA[i]), FloatUtils.EPSILON);
    }
  }
  ...
  public void testToFloat_Integer() {
    ...
    for ( int i = 0; i < AREA.length; ++i) {
      final Integer x = AREA[i];
      assertEquals((float) AREA[i], IntUtils.toFloat(x), FloatUtils.EPSILON);
    }
  }

  @Test
  public void testToFloat_Integer_float() {
    final float[] x = {Float.MIN_VALUE, Float.MIN_VALUE/2, (float) -1, (float) 0, (float) 1,
    ...
    for ( int i = 0; i < AREA.length; ++i) {
      ...
      for ( int j = 0; j < x.length; ++j) {
        assertEquals((float) AREA[i], IntUtils.toFloat(y, x[j]), FloatUtils.EPSILON);
      }
    }
  }
  ...
  public void testToDouble_int() {
    for ( int i = 0; i < AREA.length; ++i) {
      assertEquals((double) AREA[i], IntUtils.toDouble(AREA[i]), DoubleUtils.EPSILON);
    }
  }

  @Test
  public void testToDouble_Integer() {
    assertEquals(DoubleUtils.DEFAULT, IntUtils.toDouble(null), DoubleUtils.EPSILON);
    
    for ( int i = 0; i < AREA.length; ++i) {
      final Integer x = AREA[i];
      assertEquals((double) AREA[i], IntUtils.toDouble(x), DoubleUtils.EPSILON);
    }
  }
  ...
  public void testToDouble_Integer_double() {
    ...
    for ( int i = 0; i < AREA.length; ++i) {
      final Integer x = AREA[i];
      for ( int j = 0; j < a.length; ++j) {
        assertEquals((double) AREA[i], IntUtils.toDouble(x, a[j]), DoubleUtils.EPSILON);
      }
    }
  }
  ...
  public void testToByteArray_int_ByteOrder() {
    final byte[] xa = {(byte) 0x00, (byte) 0x00, (byte) 0x00, (byte) 0x00};
    assertArrayEquals(xa, IntUtils.toByteArray(0x00000000, ByteOrder.LITTLE_ENDIAN));
    assertArrayEquals(xa, IntUtils.toByteArray(0x00000000, ByteOrder.BIG_ENDIAN));
    
    final byte[] xb = {(byte) 0xAB, (byte) 0x00, (byte) 0xAB, (byte) 0x00};
    assertArrayEquals(xb, IntUtils.toByteArray(0x00AB00AB, ByteOrder.LITTLE_ENDIAN));
    assertArrayEquals(xb, IntUtils.toByteArray(0xAB00AB00, ByteOrder.BIG_ENDIAN));
    
    final byte[] xc = {(byte) 0xAB, (byte) 0xAB, (byte) 0xAB, (byte) 0xAB};
    assertArrayEquals(xc, IntUtils.toByteArray(0xABABABAB, ByteOrder.LITTLE_ENDIAN));
    assertArrayEquals(xc, IntUtils.toByteArray(0xABABABAB, ByteOrder.BIG_ENDIAN));
    
    final byte[] xd = {(byte) 0xFF, (byte) 0x00, (byte) 0xFF, (byte) 0x00};
    assertArrayEquals(xd, IntUtils.toByteArray(0x00FF00FF, ByteOrder.LITTLE_ENDIAN));
    assertArrayEquals(xd, IntUtils.toByteArray(0xFF00FF00, ByteOrder.BIG_ENDIAN));
    
    final byte[] xe = {(byte) 0xFF, (byte) 0xFF, (byte) 0xFF, (byte) 0xFF};
    assertArrayEquals(xe, IntUtils.toByteArray(0xFFFFFFFF, ByteOrder.LITTLE_ENDIAN));
    assertArrayEquals(xe, IntUtils.toByteArray(0xFFFFFFFF, ByteOrder.BIG_ENDIAN));
    
    final byte[] xf = {(byte) 0xBB, (byte) 0xAA, (byte) 0xBB, (byte) 0xAA};
    assertArrayEquals(xf, IntUtils.toByteArray(0xAABBAABB, ByteOrder.LITTLE_ENDIAN));
    assertArrayEquals(xf, IntUtils.toByteArray(0xBBAABBAA, ByteOrder.BIG_ENDIAN));
  ...
  public void testToByteArray_Integer_ByteArray_ByteOrder() {
    ...
    assertArrayEquals(xb, IntUtils.toByteArray(yb2, zb, ByteOrder.LITTLE_ENDIAN));
    ...
    assertArrayEquals(xd, IntUtils.toByteArray(yd2, zd, ByteOrder.LITTLE_ENDIAN));
    ...
    assertArrayEquals(xf, IntUtils.toByteArray(yf2, zf, ByteOrder.LITTLE_ENDIAN));
