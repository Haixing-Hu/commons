 ...
 */
public interface HtmlAttributeValue {
  ...
  public static final String LIST_TYPE_1                 = "1";

  public static final String LIST_TYPE_UPPERCASE_A       = "A";

  public static final String LIST_TYPE_LOWERCASE_A       = "a";

  public static final String LIST_TYPE_UPPERCASE_I       = "I";

  public static final String LIST_TYPE_LOWERCASE_I       = "i";
