...
public final class Ascii {
   ...
   *
   * This function converts alphabetic, numeric, and symbolic Unicode characters
   ...
   *          (4), i.e., result.length - offset >= MAX_FOLDING
   ...
   *      Latin characters in Unicode</a>
   */
  public static int fold(final char ch, final char[] result, int offset) {
    ...
    switch (ch) {
      ...
      case '\u1D94': // ᶔ [LATIN SMALL LETTER REVERSED OPEN E WITH RETROFLEX
                     // HOOK]
      ...
      case '\uFF48': // ｈ [FULLWIDTH LATIN SMALL LETTER H]
        result[offset++] = 'h';
        return 1;
      case '\u01F6': // Ƕ http://en.wikipedia.org/wiki/Hwair [LATIN CAPITAL
                     // LETTER HWAIR]
        result[offset++] = 'H';
        result[offset++] = 'V';
        return 2;
