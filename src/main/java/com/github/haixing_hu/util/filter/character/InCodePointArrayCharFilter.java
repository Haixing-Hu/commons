 ...
 * @author Haixing Hu
 */
public final class InCodePointArrayCharFilter extends AbstractCharFilter {

  private int[] acceptCodePoints;

  public InCodePointArrayCharFilter() {
    acceptCodePoints = null;
  }

  public InCodePointArrayCharFilter(final int[] acceptCodePoints) {
