...
/**
 * The base for SuffixBlackListStringFilter and SuffixWhiteListStringFilter
 * classes.
 *
 * @author Haixing Hu
 */
class SuffixListStringFilter extends AbstractStringFilter {

  private Trie    trie;
  private boolean matchReturn;
  private boolean caseInsensitive;

  protected SuffixListStringFilter(boolean matchReturn, boolean caseInsensitive) {
    this.trie = null;
