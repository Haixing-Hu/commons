 ...
 *
 * Given a string, if it matches any glob pattern in the white list of a
 * <code>GlobBlackListStringFilter<code> object, it is accepted by the
 * <code>GlobBlackListStringFilter<code> object; otherwise, it is rejected
...
public class GlobWhiteListStringFilter extends GlobStringFilter {
  ...
  public GlobWhiteListStringFilter(boolean caseInsensitive) {
