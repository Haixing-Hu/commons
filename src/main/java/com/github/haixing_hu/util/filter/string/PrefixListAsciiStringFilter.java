...
/**
 * The base class for PrefixBlackListAsciiStringFilter and
 * PrefixWhiteListAsciiStringFilter classes.
 *
 * @author Haixing Hu
 */
@NotThreadSafe
class PrefixListAsciiStringFilter extends AbstractStringFilter {

  protected AsciiTrie trie;
  protected boolean   matchReturn;
  protected boolean   caseInsensitive;

  protected PrefixListAsciiStringFilter(boolean matchReturn, boolean caseInsensitive) {
    this.trie = null;
