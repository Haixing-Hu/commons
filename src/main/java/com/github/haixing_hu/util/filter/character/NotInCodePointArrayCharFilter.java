...
/**
 * A CharFilter that accept only the characters NOT in the specified code point array.
 *
 * @author Haixing Hu
 */
public final class NotInCodePointArrayCharFilter extends AbstractCharFilter {

  private int[] rejectCodePoints;

  public NotInCodePointArrayCharFilter() {
    rejectCodePoints = null;
  }

  public NotInCodePointArrayCharFilter(final int[] rejectCodePoints) {
