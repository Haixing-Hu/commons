...
/**
 * A simple auto-expansion buffer of <code>double</code> values.
 *
 * @author Haixing Hu
 */
public final class DoubleBuffer implements Swapable<DoubleBuffer>,
  ...
  /**
   * The buffer used to store the <code>double</code> values.
   */
  protected double[] buffer;

  /**
   * The length of the array stored in this <code>double</code> buffer.
   */
