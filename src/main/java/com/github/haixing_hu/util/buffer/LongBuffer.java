...
import static com.github.haixing_hu.lang.ArrayUtils.EMPTY_LONG_ARRAY;

/**
 * A simple auto-expansion buffer of <code>long</code> values.
 *
 * @author Haixing Hu
 */
public final class LongBuffer implements Swapable<LongBuffer>,
    Assignable<LongBuffer>, Cloneable<LongBuffer>, Comparable<LongBuffer>,
    Serializable {

  private static final long serialVersionUID = 1883800278534004356L;

  static {
    BinarySerialization.register(LongBuffer.class,
        LongBufferBinarySerializer.INSTANCE);
  }

  /**
   * The buffer used to store the <code>long</code> values.
   */
  protected long[] buffer;

  /**
   * The length of the array stored in this <code>long</code> buffer.
   */
  ...
  public LongBuffer() {
    buffer = ArrayUtils.EMPTY_LONG_ARRAY;
    length = 0;
    expansionPolicy = ExpansionPolicy.getDefault();
  }

  public LongBuffer(final ExpansionPolicy expansionPolicy) {
    this.buffer = ArrayUtils.EMPTY_LONG_ARRAY;
    this.length = 0;
    this.expansionPolicy = requireNonNull("expansionPolicy", expansionPolicy);
  }

  public LongBuffer(final long[] buffer) {
    this.buffer = requireNonNull("buffer", buffer);
    this.length = 0;
    this.expansionPolicy = ExpansionPolicy.getDefault();
  }

  public LongBuffer(final long[] buffer, final ExpansionPolicy expansionPolicy) {
    this.buffer = requireNonNull("buffer", buffer);
    this.length = 0;
    this.expansionPolicy = requireNonNull("expansionPolicy", expansionPolicy);
  }

  public LongBuffer(final int bufferSize) {
    requireGreaterEqual("bufferSize", bufferSize, "zero", 0);
    if (bufferSize == 0) {
      this.buffer = EMPTY_LONG_ARRAY;
    } else {
  ...
  public LongBuffer(final int bufferSize, final ExpansionPolicy expansionPolicy) {
    requireGreaterEqual("bufferSize", bufferSize, "zero", 0);
    if (bufferSize == 0) {
      this.buffer = EMPTY_LONG_ARRAY;
    } else {
  ...
  public void append(final long ch) {
  ...
  public void append(@Nullable final long[] array) {
  ...
  public void append(@Nullable final long[] array, final int off, final int n) {
    if (array == null) {
      return;
    }
  ...
  public void append(@Nullable final LongBuffer array) {
    if ((array == null) || (array.length == 0)) {
      return;
    }
    final int newLength = length + array.length;
  ...
  public void append(@Nullable final LongBuffer array, final int off,
      final int n) {
    if (array == null) {
      return;
    }
   ...
   *         occur.
   */
  public int indexOf(final long value, int beginIndex, int endIndex) {
    if (beginIndex < 0) {
      beginIndex = 0;
    }
    if (endIndex > length) {
   ...
   *         occur.
   */
  public int lastIndexOf(final long value, int beginIndex, int endIndex) {
    if (beginIndex < 0) {
      beginIndex = 0;
    }
    if (endIndex > length) {
  ...
  public void reserve(final int n, final boolean keepContent) {
    if (buffer.length < n) {
      final long[] newBuffer = new long[n];
  ...
  @Override
  public void swap(final LongBuffer other) {
    final long[] tempBuffer = other.buffer;
  ...
  @Override
  public LongBuffer clone() {
    final LongBuffer cloned = new LongBuffer(buffer.length);
  ...
  public boolean equals(final Object obj) {
    ...
    final LongBuffer other = (LongBuffer) obj;
    return (length == other.length)
        && Equality.equals(buffer, 0, other.buffer, 0, length);
  }

  @Override
  public int compareTo(final LongBuffer other) {
    if (other == null) {
      return + 1;
    } else if (this == other) {
      return 0;
