...
/**
 * A simple auto-expansion buffer of {@code long} values.
 *
 * @author Haixing Hu
 */
public final class LongBuffer implements Swapable<LongBuffer>,
  ...
  /**
   * The buffer used to store the {@code long} values.
   */
  protected long[] buffer;

  /**
   * The length of the array stored in this {@code long} buffer.
   */
