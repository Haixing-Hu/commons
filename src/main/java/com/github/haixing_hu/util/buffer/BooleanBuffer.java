...
/**
 * A simple auto-expansion buffer of <code>boolean</code> values.
 *
 * @author Haixing Hu
 */
public final class BooleanBuffer implements Swapable<BooleanBuffer>,
  ...
  /**
   * The buffer used to store the <code>boolean</code> values.
   */
  protected boolean[] buffer;

  /**
   * The length of the array stored in this <code>boolean</code> buffer.
   */
