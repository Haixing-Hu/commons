...
/**
 * Thrown to indicates an error occurred during the pool's operation.
 *
 * @author Haixing Hu
 */
public class PoolException extends RuntimeException {

  private static final long serialVersionUID = - 2262897531114865554L;

  public PoolException() {
    super("An pool error occurred.");
  }
