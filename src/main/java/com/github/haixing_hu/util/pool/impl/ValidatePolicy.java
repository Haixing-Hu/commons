...
/**
 * The policy to validate poolable objects.
 * <p>
 ...
 * @author Haixing Hu
 */
public interface ValidatePolicy<T> {
   ...
   *
   * @param factory
   *          the {@link PoolableFactory} of the object.
   * @param obj
   ...
   */
  public boolean onBorrow(PoolableFactory<T> factory, T obj)
      throws ValidationFailedException;
   ...
   *           exception on this situation.
   */
  public boolean onRestore(PoolableFactory<T> factory, T obj)
      throws ValidationFailedException;
   ...
   *           exception on this situation.
   */
  public boolean onCheckIdle(PoolableFactory<T> factory, T obj)
      throws ValidationFailedException;
}
