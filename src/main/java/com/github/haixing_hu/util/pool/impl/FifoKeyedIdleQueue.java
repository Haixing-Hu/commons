...
/**
 * A "first in first out" fixed-capacity keyed queue for storing idle objects.
 *
 * @author Haixing Hu
 */
@ThreadSafe
public class FifoKeyedIdleQueue<K, V> extends AbstractKeyedIdleQueue<K, V> {

  public FifoKeyedIdleQueue() {
    super();
  }

  public FifoKeyedIdleQueue(final int capacity) {
    super(capacity);
  }
