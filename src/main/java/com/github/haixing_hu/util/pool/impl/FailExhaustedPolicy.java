...
/**
 * An implementation of {@link ExhaustedPolicy} which thrown an exception while
 * the pool is exhausted.
 *
 * @author Haixing Hu
 */
@Immutable
public final class FailExhaustedPolicy<T> extends AbstractExhaustedPolicy<T> {

  public FailExhaustedPolicy() {
    super();
  }

  public FailExhaustedPolicy(final int maxActiveCount) {
