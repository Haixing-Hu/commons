...
public interface ShortList extends ShortCollection {
   ...
   * returned by the given collection's {@link ShortCollection#iterator
   * iterator}.
   *
   * @param current
   ...
   * {@link java.util.List List} of {@link Short}s.
   *
   * @return my hash code
   */
  @Override
  ...
  /**
   * Returns an {@link ShortIterator iterator} over all my elements, in the
   ...
   * method. An initial call to the {@link ShortListIterator#previous previous}
