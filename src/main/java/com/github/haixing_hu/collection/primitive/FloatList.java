...
public interface FloatList extends FloatCollection {
   ...
   * returned by the given collection's {@link FloatCollection#iterator
   * iterator}.
   *
   * @param current
   ...
   *          collection
   * @param collection
   *          the {@link FloatCollection FloatCollection} of elements to add
   * @return <code>true</code> iff I changed as a result of this call
   * @throws UnsupportedOperationException
   *           when this operation is not supported
   * @throws IndexOutOfBoundsException
  ...
  /**
   * Returns <code>true</code> iff <i>that</i> is an <code>FloatList</code> that
   * contains the same elements in the same order as me. In other words, returns
   * <code>true</code> iff <i>that</i> is a <code>FloatList</code> that has the
   * same {@link #size() size} as me, and for which the elements returned by its
   * {@link FloatList#iterator iterator} are equal (<code>==</code>) to the
   ...
   * <code>FloatList</code> interface.)
   *
   * @param that
   *          the object to compare to me
   * @return <code>true</code> iff <i>that</i> is an <code>FloatList</code> that
   ...
   * <p />
   * The hash code of an <code>FloatList</code> is defined to be the result of
   ...
   * {@link java.util.List List} of {@link Float}s.
   *
   * @return my hash code
   */
  @Override
  ...
  /**
   * Returns an {@link FloatIterator iterator} over all my elements, in the
  ...
  /**
   * Returns a {@link FloatListIterator bidirectional iterator} over all my
   ...
   * returned by an initial call to the {@link FloatListIterator#next next}
   * method. An initial call to the {@link FloatListIterator#previous previous}
   ...
   * <code>FloatList</code> is backed by me, so that any changes in the returned
