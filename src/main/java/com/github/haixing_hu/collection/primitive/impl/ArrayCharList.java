...
import com.github.haixing_hu.collection.primitive.RandomAccessCharList;
...
public class ArrayCharList extends RandomAccessCharList implements CharList,
   ...
   */
  public ArrayCharList(final int initialCapacity) {
  ...
  public boolean addAll(int index, final CharCollection collection) {
    ...
    for (final CharIterator it = collection.iterator(); it.hasNext();) {
      data[index] = it.next();
      index++;
    }
