...
public abstract class RandomAccessIntList extends AbstractIntCollection
  ...
  @Override
  public abstract int removeElementAt(final int index);

  @Override
  public abstract int set(final int index, final int element);

  @Override
  public abstract void add(final int index, final int element);
  ...
  protected static class RandomAccessIntListIterator implements
      IntListIterator {
    ...
    RandomAccessIntListIterator(final RandomAccessIntList list,
        final int index) {
  ...
  protected static class RandomAccessIntSubList extends RandomAccessIntList
    ...
    public int removeElementAt(final int index) {
      ...
      final int val = source.removeElementAt(index + offset);
      --limit;
      expectedModCount = source.modCount;
      ++modCount;
      return val;
