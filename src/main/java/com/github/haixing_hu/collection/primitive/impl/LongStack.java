 ...
 * {@link ArrayLongList} where the front of the list is the bottom of the stack
...
public class LongStack {
   ...
   *          the array to add
   */
  public LongStack(final long[] numbas) {
    for (final long numba : numbas) {
      list.add(numba);
    }
  }
   ...
   */
  public long push(final long item) {
    list.add(item);
    return item;
  }
   ...
   *         stack
   */
  public int search(final long item) {
