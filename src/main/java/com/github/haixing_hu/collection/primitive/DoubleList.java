...
public interface DoubleList extends DoubleCollection {
   ...
   * returned by the given collection's {@link DoubleCollection#iterator
   * iterator}.
   *
   * @param current
   ...
   * {@link java.util.List List} of {@link Double}s.
   *
   * @return my hash code
   */
  @Override
  ...
  /**
   * Returns an {@link DoubleIterator iterator} over all my elements, in the
  ...
  /**
   * Returns a {@link DoubleListIterator bidirectional iterator} over all my
   ...
   * returned by an initial call to the {@link DoubleListIterator#next next}
   * method. An initial call to the {@link DoubleListIterator#previous previous}
